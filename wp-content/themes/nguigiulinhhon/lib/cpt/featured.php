...
function featured_post_CPT() { 
	// creating (registering) the custom type 
	register_post_type( 'featured', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Featured Posts', 'post type general name'), /* This is the Title of the Group */
			'singular_name' => __('Featured Post', 'post type singular name'), /* This is the individual type */
			'add_new' => __('Add New', 'featured post type item'), /* The add new menu item */
			'add_new_item' => __('Add New Featured Post'), /* Add New Display Title */
			'edit' => __( 'Edit' ), /* Edit Dialog */
			'edit_item' => __('Edit Featured Post'), /* Edit Display Title */
			'new_item' => __('New Featured Post'), /* New Display Title */
			...
			'description' => __( 'This is how we populate Call-to-action box on home page' ), /* Custom Type Description */
			'public' => true,
			...
			'rewrite'	=> array( 'slug' => 'featured', 'with_front' => false ), /* you can specify it's url slug */
	...
	register_taxonomy_for_object_type('post_tag', 'featured');
	
} 

	// adding the function to the Wordpress init
	add_action( 'init', 'featured_post_CPT');
	...
	*/
    ...
    register_taxonomy( 'custom_cat', 
    	array('featured'), /* if you change the name of register_post_type( 'featured', then you have to change this */
